...
$_LANG['cfg_desc']['shop_logo'] = '请在上传前将图片的文件名格式为jpg或png';
...
$_LANG['cfg_name']['comment_editdays'] = '修改评论有效期';
$_LANG['cfg_desc']['comment_editdays'] = '发布评论后多久内可以修改评论';
$_LANG['cfg_name']['comment_zhuijiadays'] = '评论追加有效期';
$_LANG['cfg_desc']['comment_zhuijiadays'] = '评论后N天内可以进行追加评论';

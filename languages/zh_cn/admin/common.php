...
$_LANG['affiliate_supplier']='店铺分成设置';
$_LANG['affiliate_supplier_ck']='店铺佣金管理';
...
$_LANG['01_affiliate_supplier_list']='店铺分成设置';
$_LANG['02_affiliate_supplier_ck']='店铺佣金管理';
$_LANG['03_affiliate_list']		= '分销设置';
$_LANG['04_distributor_list']	= '分销商列表';
$_LANG['05_distrib_goods_list'] = '商品设置';
$_LANG['06_affiliate_ck']		= '分成订单';
$_LANG['07_distrib_sort']		= '排行榜';
$_LANG['08_deposit_list']		= '提现申请列表';
$_LANG['09_push_team_commission']='地推团队佣金管理';

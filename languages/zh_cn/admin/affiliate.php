...
$_LANG['level_supplier'] = '店铺分成百分比';
$_LANG['level_push_team'] = '地推团队分成分成百分比';
...
$_LANG['help_lsa'] = '订单金额的此百分比部分作为分成用金额。';
$_LANG['help_lpta'] = '订单金额的此百分比部分作为分成用金额。';
$_LANG['help_lra'] = '介绍会员注册，介绍人所能获得的等级积分。';
$_LANG['help_lru'] = '等级积分到此上限则不再奖励介绍注册积分。';
$_LANG['help_reg_supplier'] = '注册时如果没有所属店铺时默认的所属店铺。';

...
function order_info($order_id, $order_sn = '')
{
    ...
    if ($order_id > 0)
    {
        $sql = "SELECT o.*, " . $total_fee . " FROM " . $GLOBALS['ecs']->table('order_info') ." o".
                ...
                " WHERE o.order_id = '$order_id' AND ((o.supplier_id='".$_SESSION['supplier_id']."') OR (d.supplier_id='".$_SESSION['supplier_id']."'))";
    }
    else
    {
		$sql = "SELECT o.*, " . $total_fee . " FROM " . $GLOBALS['ecs']->table('order_info') ." o".
				...
				" LEFT JOIN " .$GLOBALS['ecs']->table('card_item')." c ON b.item_id=c.id ".
				" LEFT JOIN " .$GLOBALS['ecs']->table('supplier_circle_list')." d ON c.circle_id=d.circle_id ".
                " WHERE o.order_sn = '$order_sn' AND ((o.supplier_id='".$_SESSION['supplier_id']."') OR (d.supplier_id='".$_SESSION['supplier_id']."'))";
    }
    ...
    {
		//卡项详情
		$card_item = $GLOBALS['db']->getAll("SELECT a.*,b.supplier_name FROM ".$GLOBALS['ecs']->table('card_item_goods')." a LEFT JOIN ".$GLOBALS['ecs']->table('supplier')." b ON a.supplier_id = b.supplier_id WHERE a.order_id=".$order['order_id']);
		if($card_item){

...
if($verify_result) {//验证成功
	...
	if($result=="success"){
        ...
        //$gourl="fx.asp?u=".$_SESSION['user_id']."&oid=".$order_id;
	?>
...
<div id='page'>
	...
	<br />
	<br />
	<font style=" font-size:14px!important;">祝贺您!您的订单支付已经成功!!!</font>
...
?>
	<script type="text/javascript">
		...
		//window.setTimeout("window.location='http://'+url+'/mobile/<?php echo $gourl;?>'",3000);
	</script>
    </body>
</html>
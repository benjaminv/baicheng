...
/*地推佣金变动类型*/
define('PT_BUY',              0);     //佣金分成
define('PT_ADJUSTING',       2);     //调节变动
define('PT_OTHER',            99);    //其他类型
/*店铺佣金变动类型*/
define('SUPPLIER_BUY',              0);     //佣金分成
define('SUPPLIER_SERVICE',         1);     //店铺服务费
define('SUPPLIER_ADJUSTING',       2);     //调节变动
define('SUPPLIER_OTHER',            99);    //其他类型

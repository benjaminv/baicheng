...
function extpintuan_info($extpintuan_id, $current_num = 0)
{
	...
	$extpintuan['supplier_name'] = $GLOBALS['db']->getOne( "SELECT IFNULL((SELECT supplier_name FROM ". $GLOBALS['ecs']->table('supplier')." WHERE supplier_id=".$extpintuan['supplier_id']."),'平台自营')");

...
function check_before_submit(){
	...
	var exist_service_goods = document.getElementById("exist_service_goods");
    ...
    if(checkOrderForm(the_form)){
		...
		if(exist_service_goods){
			var technican_money = document.getElementById("temp_amount").value;
			document.getElementById("technican_money").innerHTML = technican_money;
			document.getElementById("technican_cover").style.display="block";
			return false;
		}else{
			return true;
		}
...
function checkOrderForm(frm)
{
  ...
  //edit by yhy 2019/5/31检查是否选择了技师
    var exist_service_goods = document.getElementById('technican').value;
	if(exist_service_goods){
		var technican = document.getElementById('technican').value;
		if(technican == 0){
			alert('请选择技师');
			return false;
		}

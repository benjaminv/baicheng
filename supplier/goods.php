...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
	...
	$points_payment_amount = !empty($_POST['points_payment_amount']) ? intval($_POST['points_payment_amount']) : 0;
	// 积分购买金额不得超过商品售卖金额
    if ($points_payment_amount > $shop_price) {
        sys_msg("积分购买金额不得超过商品售卖金额");
    }

	$is_service = !empty($_POST['is_service']) ? $_POST['is_service'] : 0;
    ...
    if ($is_insert)
    {
        if ($code == '')
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    "cat_id, cost_price, brand_id, shop_price, market_price,points_payment_amount,is_service,poster_id,service_group, is_promote, zhekou, promote_price, " .
                ...
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', '$cost_price', " .
                    "'$brand_id', '$shop_price', '$market_price','$points_payment_amount','$is_service','$poster_id','$service_group', '$is_promote', '$zhekou', '$promote_price', ".

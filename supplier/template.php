...
if ($_REQUEST['act'] == 'list')
{
    ...
    /* 获得当前的模版的信息 */
    $curr_template = $db->getOne('select value from ecs_supplier_shop_config where code="template" and supplier_id="'.$_SESSION['supplier_id'].'"');
   
    $_CFG['template'] = $curr_template;
